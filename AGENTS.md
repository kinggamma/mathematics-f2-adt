# Mathematics for Secondary Schools Student’s Book Form Two — ADT Bundle Reference
...
**Mathematics for Secondary Schools Student’s Book Form Two** — This is an English-language Form Two mathematics textbook for lower secondary students in Tanzania, published by the Tanzania Institute of Education for the Ordinary Secondary Education curriculum. It covers core topics such as rates and variation, congruence and similarity, algebra, exponents and radicals, logarithms, sets, and trigonometry, roughly targeting early secondary learners around Grade 8–10 level. The book uses a competency-based, activity-driven approach with examples, projects, revision exercises, and real-life applications to build problem-solving skills and connect mathematics to everyday situations.
...
├── MATHEMATIC-F2-v5.db                    # SQLite database (pipeline state)
├── MATHEMATIC-F2-v5.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg002_im002` |
...
{
  "pg001_gp001_tx001": "",
  "pg002_im002": "Green official certificate titled “Certificate of Approval” issued by the United Republic of Tanzania, Ministry of Education, Science and Technology, with certificate number 1586. It approves the publication “Mathematics for Secondary Schools Student’s Book, Form Two,” listing the Tanzania Institute of Education as both publisher and author, ISBN 978-9912-756-31-1, and stating that the book was approved on 11 September 2024 as a textbook for Form Two students in Tanzania secondary schools under the 2023 syllabus. A signature appears at the lower left above the name Dr Lyabwene M. Mtahabwa, Commissioner for Education.",
  "gl001": "~",
  "gl001_def": "A mathematical symbol meaning “is similar to.”"
}
```
...
```json
{
  "~": {
    "word": "~",
    "definition": "A mathematical symbol meaning “is similar to.”",
    "variations": ["~"],
    "emoji": "🔣🔁"
  }
}
...
```json
{
  "title": "Mathematics for Secondary Schools Student’s Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<html lang="en-GB">
<head>
    <meta name="title-id" content="pg008_sec001" />      <!-- section identity -->
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
                 data-section-id="pg008_sec001">
            <!-- Images use relative paths and carry data-id for alt text lookup -->
            <img data-id="pg002_im002" src="images/pg002_im002.png" ...>
...
| Original PDF | `MATHEMATIC-F2-v5.pdf` |
| Pipeline database | `MATHEMATIC-F2-v5.db` (SQLite) |
